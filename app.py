...
<div class="welcome-card">
    <h1>Hi there! Welcome to Signature Verification</h1>
    <p>Hope your day is going great! Make your day even more joyful by testing if a signature is genuine or forged.</p>
    <p>Upload an image below and let's verify it!</p>
</div>
""", unsafe_allow_html=True)
...
st.markdown("<div class='footer'><p>Thank you for using our service! Visit again.</p><p>*Made by Sujana*</p></div>", unsafe_allow_html=True)